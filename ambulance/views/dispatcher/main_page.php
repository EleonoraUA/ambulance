        ...
        <div class="col-xs-6 col-md-2">
            <ul class="list-group">
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    <a href="/calls/index">
                        Виклики <span class="label label-success">2</span>
                    </a>

                </li>
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    <a href="/symptoms/index">
                        Симптоми
                    </a>
                </li>
                <li class="list-group-item d-flex justify-content-between align-items-center">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        (function() {
            ...
            var southWest = new google.maps.LatLng(50.49, 30.600);
